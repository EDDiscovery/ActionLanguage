...
namespace ActionLanguage
{
    ...
    public class ActionCall : ActionBase
    {
        ...
        public override bool Configure(ActionCoreController cp, List<TypeHelpers.PropertyNameInfo> eventvars, ActionConfigFuncs configFuncs)
        {
            ...
            if (promptValue != null)
            {
                return configFuncs.SetVariables("Variables to pass into called program", cp.Icon, cond, showatleastoneentry: true, allownoexpand: true, altops: altops, resultact: (v, a) =>
                {
